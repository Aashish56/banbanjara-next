...
const DestinationPage = (props) => {
  ...
  useEffect(() => {
    if (destinationList?.exploreNearby) {
      setData(destinationList?.exploreNearby);
      setListing(destinationList?.exploreNearby);
    }
  }, [destinationList]);
      ...
      cell: (row) => (
        <Dropdown style={{ border: "1px solid black" }}>
          ...
          <Dropdown.Menu>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/destination/explore/edit/${row._id}?list=${router.query?.id}`}
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/destination/explore/view/${row._id}?list=${router.query?.id}`}
    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", margin: 10 }}>
        <Button
          ...
          style={{ width: 100 }}
          onClick={() => {
            router.push(`/admin/destination/explore/add/${router.query?.id}`);
          }}
        >
          {"Add "}
