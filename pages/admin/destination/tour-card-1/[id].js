...
import { getDestionDetails } from "redux/actions/destination";
...
const DestinationPage = (props) => {
  ...
  useEffect(() => {
    if (destinationList?.tourCards1) {
      setData(destinationList?.tourCards1);
      setListing(destinationList?.tourCards1);
    }
  }, [destinationList]);
      ...
      cell: (row) => (
        <Dropdown style={{ border: "1px solid black" }}>
          ...
          <Dropdown.Menu>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/destination/tour-card-1/edit/${row._id}?list=${router.query?.id}`}
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/destination/tour-card-1/view/${row._id}?list=${router.query?.id}`}
    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", margin: 10 }}>
        <Button
          ...
          style={{ width: 100 }}
          onClick={() => {
            router.push(`/admin/destination/tour-card-1/add/${router.query?.id}`);
          }}
        >
          {"Add "}
