...
import {
  getAllWhatsIncluded,
  updateWhatsIncludedStatus,
} from "../../../../redux/actions/whatsIncluded";
// import {
//   getAllWhatsIncluded,
//   updateWhatsIncludedStatus,
// } from "../../../../redux/actions/whatsIncluded";
...
const WhatsIncluded = (props) => {
  ...
  useEffect(() => {
    props.setTitle("What's Included");
  }, []);
  ...
  useEffect(() => {
    dispatch(getAllWhatsIncluded());
  }, []);
  const WhatsIncludedList = useSelector((state) => state.whatsIncluded);
  console.log("SetData 👌✔", data);

  useEffect(() => {
    setData(WhatsIncludedList);
    console.log(WhatsIncludedList, "data ✔✔");
  }, [WhatsIncludedList]);
  ...
  useEffect(() => {
    try {
      ...
      if (searchName && selectStatus) {
        filterData = WhatsIncludedList?.filter((a) => {
      ...
      cell: (row) => (
        <Dropdown style={{ border: "1px solid black" }}>
          ...
          <Dropdown.Menu>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/master/whatsIncluded/edit/${row._id}`}
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/master/whatsIncluded/view/${row._id}`}
    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", margin: 10 }}>
        <Button
          ...
          style={{ width: 100 }}
          onClick={() => {
            router.push("/admin/master/whatsIncluded/add");
          }}
        >
          {"Add "}
