...
// redux
import { getAllTaxes, updateTaxesStatus } from "../../../../redux/actions";
// components
  ...
  const columns = [
    {
      name: "Name",
      sortable: true,
      selector: (row) => <span className="text-capital">{row.taxValue}</span>,
    },
    {
      name: "Status",
      sortable: true,
      ...
      cell: (row) => (
        <Dropdown style={{ border: "1px solid black" }}>
          ...
          <Dropdown.Menu>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/master/taxes/edit/${row._id}`}
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/master/taxes/view/${row._id}`}
    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", margin: 10 }}>
        <Button
          ...
          style={{ width: 100 }}
          onClick={() => {
            router.push("/admin/master/taxes/add");
          }}
        >
          {"Add "}
