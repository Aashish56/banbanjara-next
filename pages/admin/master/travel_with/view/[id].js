...
const ViewInclusion = (props) => {
  const router = useRouter();

  const allData = useSelector((state) => state.travelWith);
  const inclusion = allData.find((it) => it._id === router.query.id);

  useEffect(() => {
    props.setTitle("View Travel With");
  }, []);
  return (
    <>
