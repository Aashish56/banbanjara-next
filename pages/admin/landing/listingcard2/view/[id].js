...
const ViewLanding = (props) => {
  ...
  useEffect(() => {
    props.setTitle("View Listing 2 Page");
  }, []);

  useEffect(() => {
    if (inclusions?.listingCard2?.length > 0) {
      setData(inclusions.listingCard2.filter(item => item._id === router.query.id));
    }
  }, [inclusions]);
          ...
          <Table bordered hover>
            ...
            <tr>
              ...
              <tr>
                ...
                <td>{data?.length > 0 && data[0]?.distance || ""}</td>
              </tr>
              <tr>
                <th
                  className="text-right"
              ...
              <tr>
                ...
                <td>{data?.length > 0 && data[0].knownfor || ""}</td>
              </tr>
              <tr>
                <th
                  className="text-right"
                ...
                <td>{data?.length > 0 && data[0]?.covidCases || ""}</td>
              </tr>
              <tr>
                <th
                  className="text-right"
                ...
                <td>{data?.length > 0 && data[0]?.title || ""}</td>
              </tr>
            </tbody>
          </Table>
        </Card.Body>
