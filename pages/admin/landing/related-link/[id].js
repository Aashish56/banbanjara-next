...
const LandingPage = (props) => {
  ...
  useEffect(() => {
    props.setTitle("Related Links 1");
  }, []);
  ...
  useEffect(() => {
    if(landingList?.relatedLinks1) {
      setData(landingList?.relatedLinks1);
      setListing(landingList?.relatedLinks1);
    }
  }, [landingList]);
      ...
      cell: (row) => (
        <Dropdown style={{ border: "1px solid black" }}>
          ...
          <Dropdown.Menu>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/related-link/edit/${row._id}?list=${router.query?.id}`}
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/related-link/view/${row._id}?list=${router.query?.id}`}
    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", margin: 10 }}>
        <Button
          ...
          style={{ width: 100 }}
          onClick={() => {
            router.push(`/admin/landing/related-link/add/${router.query?.id}`);
          }}
        >
          {"Add "}
