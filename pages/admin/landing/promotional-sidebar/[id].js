...
const LandingPage = (props) => {
  ...
  useEffect(() => {
    if (landingList?.pormotionalSidebar) {
      setData(landingList?.pormotionalSidebar);
      setListing(landingList?.pormotionalSidebar);
    }
  }, [landingList]);
      ...
      cell: (row) => (
        <Dropdown style={{ border: "1px solid black" }}>
          ...
          <Dropdown.Menu>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/promotional-sidebar/edit/${row._id}?list=${router.query?.id}`}
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/promotional-sidebar/view/${row._id}?list=${router.query?.id}`}
    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: "flex-end", margin: 10 }}>
        <Button
          ...
          style={{ width: 100 }}
          onClick={() => {
            router.push(`/admin/landing/promotional-sidebar/add/${router.query?.id}`);
          }}
        >
          {"Add "}
