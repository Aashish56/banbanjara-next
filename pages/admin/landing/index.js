...
import { getAllLandingPages, updateLanding } from "redux/actions/landing";
...
const LandingPage = (props) => {
  ...
  useEffect(() => {
    props.setTitle("Landing Page");
  }, []);
  const handleClose = () => setShow(false);
  const handleShow = () => setShow(true);
  const changeStatus = (_id, isDisable) => {
    dispatch(
      updateLanding({ isDisable: !isDisable }, _id)
    );
  };
  ...
  useEffect(() => {
    try {
      ...
      if (searchName && selectStatus) {
        ...
        filterData = landingData?.filter((a) => {
  ...
  const columns = [
    ...
    },
    {
      name: "URL",
      sortable: true,
      selector: (row) => <a href={typeof window != 'undefined' && `${window.location.origin}/landing/${row?.title?.toLowerCase().split(' ').join('-')}`}>
        {typeof window != 'undefined' && `${window.location.origin}/landing/${row?.title?.toLowerCase().split(' ').join('-')}`}
      </a>
    },
    {
      name: "Action",
      ...
      cell: (row) => (
        <Dropdown style={{ border: "1px solid black" }}>
          ...
          <Dropdown.Menu>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/edit/${row._id}`}
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/listingcard/${row._id}`}
                iconclassName="bi bi-pencil-square"
                menuTitle="Manage Listing Card 1"
              />
            </Dropdown.Item>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/listingcard2/${row._id}`}
                iconclassName="bi bi-pencil-square"
                menuTitle="Manage Listing Card 2"
              />
            </Dropdown.Item>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/listingcard3/${row._id}`}
                iconclassName="bi bi-pencil-square"
                menuTitle="Manage Listing Card 3"
              />
            </Dropdown.Item>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/related-articles/${row._id}`}
                iconclassName="bi bi-pencil-square"
                menuTitle="Manage Related Articles"
              />
            </Dropdown.Item>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/promotional-sidebar/${row._id}`}
                iconclassName="bi bi-pencil-square"
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/explore/${row._id}`}
                iconclassName="bi bi-pencil-square"
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/faq/${row._id}`}
                iconclassName="bi bi-pencil-square"
            ...
            {/* <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/related-link/${row._id}`}
                iconclassName="bi bi-pencil-square"
                menuTitle="Manage Related Link 1"
              />
            </Dropdown.Item>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/related-link-2/${row._id}`}
                iconclassName="bi bi-pencil-square"
                menuTitle="Manage Related Link 2"
              />
            </Dropdown.Item> */}
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/weather/${row._id}`}
                iconclassName="bi bi-pencil-square"
                menuTitle="Manage Local Weather"
              />
            </Dropdown.Item>
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/general-info/${row._id}`}
                iconclassName="bi bi-pencil-square"
            ...
            <Dropdown.Item>
              <MenuLink
                href={`/admin/landing/view/${row._id}`}
