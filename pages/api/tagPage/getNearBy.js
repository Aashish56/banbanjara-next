    ...
    try {
        ...
        try {
            if (req.body.city) {
                ...
                res.send({
                    status: true,
                    message: "Near By for City fetched Sucessfully",
                    data: data,
                });
                return;
            }
            if (req.body.state) {
                ...
                res.send({
                    status: true,
                    message: "Near By for State fetched Sucessfully",
                    data: data,
                });
                return;
            }
            if (req.body.country) {
                ...
                res.send({
                    status: true,
                    message: "Near By for Country fetched Sucessfully",
                    data: data,
                });
                return;
            }
            ...
            await errorResponseHelper({
                res,
                error: e,
                defaultMessage: "Error while fething data with for Explore Near By",
            });
        }
...
export default handler(getNearBy);