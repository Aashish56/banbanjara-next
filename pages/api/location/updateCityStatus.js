...
async function updateCityStatus(req, res) {

    await dbConnect();
    try {
        try {
            let validateData = updateCityStatusSchema.validate(req.body);
            ...
            await errorResponseHelper({
                res,
                error: e,
                defaultMessage: "Error in updateCityStatus",
            });
        }
    } catch (error) {
        console.log(error);
...
export default handler(updateCityStatus);