...
async function updateTravelWithStatus(req, res) {
    try {
        ...
        let updateModule = await travelWith.findOneAndUpdate({ _id: bodyData._id }, { $set: setData });
...
export default handler(updateTravelWithStatus);