...
const getQuickFactStatusSchema = Joi.object({
...
async function updateQuickFact(req, res) {
    ...
    try {
        ...
        try {
            ...
            let validateData = getQuickFactStatusSchema.validate(req.body);
            ...
            let updateModule = await quickFact.findOneAndUpdate({ _id: bodyData._id }, { $set: setData });
...
export default handler(updateQuickFact);