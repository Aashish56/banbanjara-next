...
const getTourGraphicStatusSchema = Joi.object({
...
async function updateStatus(req, res) {
    ...
    try {
        ...
        try {
            ...
            let validateData = getTourGraphicStatusSchema.validate(req.body);
            ...
            let updateModule = await tourGraphic.findOneAndUpdate({ _id: bodyData._id }, { $set: setData });
