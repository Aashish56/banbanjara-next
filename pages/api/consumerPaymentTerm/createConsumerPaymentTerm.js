...
async function createConsumerPaymentTerm(req, res) {
    try {
        ...
        let saveModule = await new consumerPaymentTerm(bodyData).save();
...
export default handler(upload(createConsumerPaymentTerm,'consumerPaymentTerm','image'));
