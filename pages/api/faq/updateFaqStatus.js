...
const getFaqStatusSchema = Joi.object({
...
async function updateStatus(req, res) {
    ...
    try {
        ...
        try {
            ...
            let validateData = getFaqStatusSchema.validate(req.body);
            if (validateData.error) {
            ...
            let updateModule = await Models.FaqDB.findOneAndUpdate({ _id: bodyData._id }, { $set: setData });
